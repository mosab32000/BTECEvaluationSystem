...
class AIEvaluator:
    ...
    def evaluate(self, task_submission):
        ...
        try:
            ...
            logging.error(f"Unexpected error in evaluation: {e}")
            return f"Error during AI evaluation: {str(e)}"
    ...
    def evaluate_with_json(self, task_submission):
        ...
        try:
            ...
            logging.error(f"OpenAI API request error in JSON evaluation: {e}")
            return {
                "grade": "Error",
            ...
            logging.error(f"Unexpected error in JSON evaluation: {e}")
            return {
                "grade": "Error",
                "feedback": [f"Error during AI evaluation: {str(e)}"],
                "improvement_areas": ["Try again later"],
    ...
    def evaluate_with_rubric(self, task_submission, rubric=None):
        ...
        try:
            ...
            logging.error(f"OpenAI API request error in rubric evaluation: {e}")
            return {
                "grade": "Error",
                "total_score": 0,
                "sections": [],
            ...
            logging.error(f"Unexpected error in rubric evaluation: {e}")
            return {
                "grade": "Error",
                "total_score": 0,
                "sections": [],
